          ...
          <div className="flex flex-wrap gap-2">
            {(targetCanSell || isSellingTarget) && (
              ...
              >
                ...
                {isSellingTarget
                  ? 'Selling...'
                  : `Sell ${p.target_position} → ~$${(p.target_balance * p.target_current_price * (1 - getOrderSettings().slippage / 100)).toFixed(2)}`}
              </button>
            )}
            {targetCanSellUnwanted && (
              <button
          ...
          <div className="flex flex-wrap gap-2">
            {(coverCanSell || isSellingCover) && (
              ...
              >
                ...
                {isSellingCover
                  ? 'Selling...'
                  : `Sell ${p.cover_position} → ~$${(p.cover_balance * p.cover_current_price * (1 - getOrderSettings().slippage / 100)).toFixed(2)}`}
              </button>
            )}
