      ...
      <span className="purchase-flow-hint-tooltip">
        ...
        <span className="purchase-flow-hint-content">
          ...
          <span className="purchase-flow-hint-step">
            ...
            <span><strong>Sell Unwanted</strong> — Automatically sells the opposite side (e.g., sells NO if you want YES) via CLOB order at configured slippage.</span>
          </span>
          <span className="purchase-flow-hint-step">
        ...
        <span className="purchase-flow-hint-labels">
          ...
          <span><strong style={{ color: 'rgb(251 191 36)' }}>Pending</strong> — Order failed (no liquidity), tokens held waiting for retry</span>
